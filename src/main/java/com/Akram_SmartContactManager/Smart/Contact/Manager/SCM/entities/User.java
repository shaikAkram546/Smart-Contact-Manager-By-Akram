package com.Akram_SmartContactManager.Smart.Contact.Manager.SCM.entities;
...
@Builder
 public class User implements UserDetails {
     ...
     // information
     private boolean enabled = true; // This has to be false when akram make email verfication. till then it need to be true..
